...
class PolicyValueNetwork(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        # Residual block 26
        h51 = F.relu(self.norm51(u51))
        h52 = F.relu(self.norm52(self.l52(h51)))
        u53 = self.l53(h52) + u51
        # Residual block 27
        h53 = F.relu(self.norm53(u53))
        h54 = F.relu(self.norm54(self.l54(h53)))
        u55 = self.l55(h54) + u53
        # Residual block 28
        h55 = F.relu(self.norm55(u55))
        h56 = F.relu(self.norm56(self.l56(h55)))
        u57 = self.l57(h56) + u55
        # Residual block 29
        h57 = F.relu(self.norm57(u57))
        h58 = F.relu(self.norm58(self.l58(h57)))
        u59 = self.l59(h58) + u57
        # Residual block 30
        h59 = F.relu(self.norm59(u59))
        h60 = F.relu(self.norm60(self.l60(h59)))
        u61 = self.l61(h60) + u59
        # Residual block 31
        h61 = F.relu(self.norm61(u61))
        h62 = F.relu(self.norm62(self.l62(h61)))
        u63 = self.l63(h62) + u61
        # Residual block 32
        h63 = F.relu(self.norm63(u63))
        h64 = F.relu(self.norm64(self.l64(h63)))
        u65 = self.l65(h64) + u63
        # Residual block 33
        h65 = F.relu(self.norm65(u65))
        h66 = F.relu(self.norm66(self.l66(h65)))
        u67 = self.l67(h66) + u65
        # Residual block 34
        h67 = F.relu(self.norm67(u67))
        h68 = F.relu(self.norm68(self.l68(h67)))
        u69 = self.l69(h68) + u67
        # Residual block 35
        h69 = F.relu(self.norm69(u69))
        h70 = F.relu(self.norm70(self.l70(h69)))
        u71 = self.l71(h70) + u69

        # Residual block 36
        h71 = F.relu(self.norm71(u71))
        h72 = F.relu(self.norm72(self.l72(h71)))
        u73 = self.l73(h72) + u71
        # Residual block 37
        h73 = F.relu(self.norm73(u73))
        h74 = F.relu(self.norm74(self.l74(h73)))
        u75 = self.l75(h74) + u73
        # Residual block 38
        h75 = F.relu(self.norm75(u75))
        h76 = F.relu(self.norm76(self.l76(h75)))
        u77 = self.l77(h76) + u75
        # Residual block 39
        h77 = F.relu(self.norm77(u77))
        h78 = F.relu(self.norm78(self.l78(h77)))
        u79 = self.l79(h78) + u77
        # Residual block 40
        h79 = F.relu(self.norm79(u79))
        h80 = F.relu(self.norm80(self.l80(h79)))
        u81 = self.l81(h80) + u79
        # Residual block 41
        h81 = F.relu(self.norm81(u81))
        h82 = F.relu(self.norm82(self.l82(h81)))
        u83 = self.l83(h82) + u81
        # Residual block 42
        h83 = F.relu(self.norm83(u83))
        h84 = F.relu(self.norm84(self.l84(h83)))
        u85 = self.l85(h84) + u83
        # Residual block 43
        h85 = F.relu(self.norm85(u85))
        h86 = F.relu(self.norm86(self.l86(h85)))
        u87 = self.l87(h86) + u85
        # Residual block 44
        h87 = F.relu(self.norm87(u87))
        h88 = F.relu(self.norm88(self.l88(h87)))
        u89 = self.l89(h88) + u87
        # Residual block 45
        h89 = F.relu(self.norm89(u89))
        h90 = F.relu(self.norm90(self.l90(h89)))
        u91 = self.l91(h90) + u89
        # Residual block 46
        h91 = F.relu(self.norm91(u91))
        h92 = F.relu(self.norm92(self.l92(h91)))
        u93 = self.l93(h92) + u91
        # Residual block 47
        h93 = F.relu(self.norm93(u93))
        h94 = F.relu(self.norm94(self.l94(h93)))
        u95 = self.l95(h94) + u93
        # Residual block 48
        h95 = F.relu(self.norm95(u95))
        h96 = F.relu(self.norm96(self.l96(h95)))
        u97 = self.l97(h96) + u95
        # Residual block 49
        h97 = F.relu(self.norm97(u97))
        h98 = F.relu(self.norm98(self.l98(h97)))
        u99 = self.l99(h98) + u97
        # Residual block 50
        h99 = F.relu(self.norm99(u99))
        h100 = F.relu(self.norm100(self.l100(h99)))
        u101 = self.l101(h100) + u99
        h101 = F.relu(self.norm101(u101))
        ...
        h102_v = F.relu(self.norm102_v(self.l102_v(h101)))
        h103_v = F.relu(self.l103_v(torch.flatten(h102_v, 1)))
