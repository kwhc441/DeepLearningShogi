...
class PolicyValueNetwork(nn.Module):
    def __init__(self):
        ...
        self.l82 = nn.Conv2d(in_channels=k, out_channels=MAX_MOVE_LABEL_NUM, kernel_size=1, bias=False)
        self.l82_2 = Bias(9*9*MAX_MOVE_LABEL_NUM)
        ...
        self.l82_v = nn.Conv2d(in_channels=k, out_channels=MAX_MOVE_LABEL_NUM, kernel_size=1)
        self.l83_v = nn.Linear(9*9*MAX_MOVE_LABEL_NUM, fcl)
        self.l84_v = nn.Linear(fcl, 1)
        ...
        self.norm82_v = nn.BatchNorm2d(MAX_MOVE_LABEL_NUM, eps=2e-05)
    ...
    def forward(self, x1, x2):
        ...
        h82 = self.l82(h81)
        h82_1 = self.l82_2(torch.flatten(h82, 1))
        # value network
        ...
        h82_v = F.relu(self.norm82_v(self.l82_v(h81)))
        h83_v = F.relu(self.l83_v(torch.flatten(h82_v, 1)))
